...
const PopUp = () => {
  ...
  return (
    <div className={styles.wrapper} onClick={closePopUp}>
      <div className={styles.container} ref={card}>
        <svg onClick={closePopUp} className={styles.closeIcon} width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
